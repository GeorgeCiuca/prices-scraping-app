...
class App():
    def __init__(self):
        ...
        self.statistics_btn.place(x=800, y=120)
    ...
    def statistics_page(self, event):
        ...
        self.clicked = StringVar()
        self.clicked.set("Select product...")
        self.drop = OptionMenu(self.add_frame, self.clicked, *product_names)
        self.drop.config(font=("Calibri", 15))
        self.drop.place(x=40, y=150)
